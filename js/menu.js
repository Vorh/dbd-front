...
function forTest() {
    var todo = new CreateTodo('teвавыаte', "анизации с плоской структурой, у которых в пронизанном лучами солнечного света офисном воздухе постоянно витает дух равенства и братства. Говоря о первых приходящих в голову образах, наверняка вы уже представили себе небоскреб крупно",1);
    ...
    var todo2 =new  CreateTodo('ПАВПВАПВА', "fdsfds",3);
    todo2.complete = true;
    ...
    todo7.deleted = true;
    var todo8 = new CreateTodo('tetавыаыe', " Вполне вероятно, что в одной из таких работаете и в",10);
    todo8.type = 2;
